...
3. Give the bot a handle (ex: `holidayBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://holidaybot-shaydontag.azurewebsites.net/api/messages`
